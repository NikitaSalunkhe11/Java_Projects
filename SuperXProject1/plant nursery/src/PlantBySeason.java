...
public class PlantBySeason extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        imageView1.setOnMouseClicked(event -> {
            ...
            lastPage.LastPageMethod(new Stage(), image1, "Pollution Killer Plants", "₹ 599/-",
                    "This pack contains best 5 air purifier plants + 5 colorful Pots.\r\n"
        ...
        imageView2.setOnMouseClicked(event -> {
            // Create a new instance of the LastPage class and call its start method
            LastPage lastPage = new LastPage();
            lastPage.LastPageMethod(new Stage(), image2, "Mini Succulent Garden", "₹ 1222/-",
                    "This pack contains 6 best succulent plants + 6 Colorful Pots.\r\n" + //
                            "\r\n" + //
                            "About\r\n" + //
        ...
        imageView3.setOnMouseClicked(event -> {
            // Create a new instance of the LastPage class and call its start method
            LastPage lastPage = new LastPage();
            lastPage.LastPageMethod(primaryStage, image3, "Miniature Garden", "₹ 699/-",
                    "This miniature garden contains a Syngonium plant along with a ceramic pot,pebbles, stone sand, \r\n"
        ...
        imageView4.setOnMouseClicked(event -> {
            // Create a new instance of the LastPage class and call its start method
            LastPage lastPage = new LastPage();
            lastPage.LastPageMethod(primaryStage, image4, "Nikita", "133/-",
                    "This miniature garden contains a Syngonium plant along with a ceramic pot,pebbles, stone sand, \\r\\n"
                            + //
                            "\"+\"garden toys and preserve moss.\\r\\n" + //
                            "\"+\r\n" + //
        ...
        imageView5.setOnMouseClicked(event -> {
            // Create a new instance of the LastPage class and call its start method
            LastPage lastPage = new LastPage();
            lastPage.LastPageMethod(primaryStage, image1, "Charming Christmas Celebrations", STYLESHEET_MODENA,
                    STYLESHEET_CASPIAN);
        });
        imageView5.setFitWidth(320);
        imageView5.setFitHeight(320);

        Label labelgardningPlant = new Label("  Plant By Season");
